...
{
    internal static class GetBestMatchesRestSdkExample
    {
        public static void Go(string LicenseKey, bool IsLive)
        { 
            Console.WriteLine("\r\n---------------------------------------------------");
            Console.WriteLine("Address Validation US 3 - GetBestMatches - REST SDK");
            Console.WriteLine("---------------------------------------------------");

            GetBestMatchesClient.GetBestMatchesInput getBestMatchesInput = new(
                "",
            ...
            Console.WriteLine($"Business Name: {getBestMatchesInput.BusinessName}");
            Console.WriteLine($"Address 1    : {getBestMatchesInput.Address}");
            Console.WriteLine($"Address 2    : {getBestMatchesInput.Address2}");
            Console.WriteLine($"City         : {getBestMatchesInput.City}");
            Console.WriteLine($"State        : {getBestMatchesInput.State}");
            Console.WriteLine($"ZIP Code     : {getBestMatchesInput.PostalCode}");
            Console.WriteLine($"Is Live      : {getBestMatchesInput.IsLive.ToString()}");
            Console.WriteLine($"License Key  : {getBestMatchesInput.LicenseKey}");


            GBMResponse response = GetBestMatchesClient.Invoke(getBestMatchesInput);
